...
направления, проверяет гипотезы planning-scout по всей затронутой поверхности,
мигрирует все call sites, организует работу сабагентов, запускает тяжёлые проверки и в

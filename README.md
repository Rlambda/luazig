...
5. После P15.38a–e: геометрическое среднее **≤3×**. ❌ (достигнуто 3.74×)
...
**Итог P15.38 (a–e):** geomean **4.77× → 3.74×** (-21.6% slowdown).
Цель ≤3× почти достигнута — оставшиеся hotspot'ы: `lua_calls` (6.40×,
call frame overhead), `hash_access` (7.66×, Node 48B vs 24B),

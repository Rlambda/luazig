...
| Benchmark | До P15.31 | P15.31 | P15.32b | До→P15.32b |
|---|---|---|---|---|
| int_arith | 9.605 | 8.715 | 1.735 | 5.5× |
| global_arith | 15.863 | 14.879 | 7.716 | 2.1× |
| branch_loop | 12.913 | 11.344 | 4.164 | 3.1× |
| lua_calls | 3.523 | 3.427 | 2.719 | 1.3× |
| array_access | 1.315 | 1.155 | 0.426 | 3.1× |
| hash_access | 1.655 | 1.395 | 0.644 | 2.6× |
| temp_table_alloc | 0.224 | 0.223 | 0.154 | 1.5× |
| string_loop | 0.528 | 0.533 | 0.448 | 1.2× |
| coroutine_yield | 0.429 | 0.411 | 0.329 | 1.3× |
| dynamic_load | 1.224 | 1.122 | 0.409 | 3.0× |

Геометрическое среднее ускорения: **2.08×** (до P15.31 → P15.32b).
...
8.7→1.7s, branch_loop 11.3→4.2s, dynamic_load 1.1→0.4s.

...
| Benchmark | До P15.31 | P15.31 | P15.32a | P15.32b | P15.31→P15.32b |
|---|---|---|---|---|---|
| int_arith | 9.605 | 8.715 | 7.899 | 1.164 | 7.5× |
| global_arith | 15.863 | 14.879 | 14.385 | 7.288 | 2.0× |
| branch_loop | 12.913 | 11.344 | 10.223 | 3.493 | 3.2× |
| lua_calls | 3.523 | 3.427 | 3.293 | 2.638 | 1.3× |
| array_access | 1.315 | 1.155 | 1.084 | 0.400 | 2.9× |
| hash_access | 1.655 | 1.395 | 1.318 | 0.613 | 2.3× |
| temp_table_alloc | 0.224 | 0.223 | 0.226 | 0.149 | 1.5× |
| string_loop | 0.528 | 0.533 | 0.529 | 0.450 | 1.2× |
| coroutine_yield | 0.429 | 0.411 | 0.400 | 0.320 | 1.3× |
| dynamic_load | 1.224 | 1.122 | 1.050 | 0.347 | 3.2× |

Геометрическое среднее ускорения: **2.41×** (до P15.31 → P15.32b), **2.24×**
(P15.31 → P15.32b).

Основной вклад дал P15.32b (условный CLOSE): int_arith 7.9→1.2s, branch_loop
10.2→3.5s, array_access 1.1→0.4s. P15.32a (устранение MOVE для local reads)
дал 3–10% на большинстве workloads. P15.31 (typed fast paths) дал 5–15%.
...
- [ ] RuntimeFrame синхронизируется только на safepoints.
- [ ] Cold continuation/debug/error paths вынесены из hot function.
- [ ] GC fast check сводится к дешёвому debt comparison; реальное продвижение
  collector выполняется на allocation/safepoint path.
- [ ] Добавить benchmark и assertion, что выключенные hooks не ведут через hook
  machinery.

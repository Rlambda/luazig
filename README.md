...
| Smoke tests (`tests/smoke/*.lua`) | **57/57** match (byte-identical stdout+stderr+exit) |
...
Geomean slowdown vs PUC Lua: **2.36x** (lower is better; 1.0x = parity).
...
| array_access | 3.48x |
| mixed_arith | 3.44x |
| coroutine_yield | 3.22x |
| int_arith | 2.79x |
| global_arith | 2.68x |
| field_access | 2.51x |
| float_arith | 2.46x |
| lua_calls | 2.29x |
| temp_table_alloc | 2.17x |
| branch_loop | 2.03x |
| dynamic_load | 1.78x |
| comparisons | 1.41x |
| string_loop | 1.31x |

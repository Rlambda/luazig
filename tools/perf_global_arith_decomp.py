    ...
    artifact = {
        ...
        "bytecode": {
            ...
            "note": (
                ...
                "The previous claim 'PUC executes MMBIN as a no-op fast check; "
                "ops_per_iter_puc = 5' was FALSE — verified via PUC count hook: "
                "N=10 -> 52 hits, N=20 -> 92 hits, delta = 40, i.e. 4.0 ops/iter."
            ),
